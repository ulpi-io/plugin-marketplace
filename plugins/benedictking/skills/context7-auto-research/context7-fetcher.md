...
1. **Search libraries**: `node context7-api.cjs search <libraryName> <query>`
2. **Get documentation**: `node context7-api.cjs context <libraryId> <query>`
...
node .claude/skills/context7-auto-research/context7-api.cjs context "/vercel/next.js/v15.1.8" "middleware"
```

## Execution Flow

1. **Call API**: Execute context7-api.cjs script
