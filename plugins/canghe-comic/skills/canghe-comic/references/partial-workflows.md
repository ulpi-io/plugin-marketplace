...
```bash
/canghe-comic content.md --storyboard-only
```
...
```bash
/canghe-comic content.md --prompts-only
```
...
```bash
/canghe-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/canghe-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/canghe-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/canghe-comic comic/topic-slug/ --regenerate 0
```
