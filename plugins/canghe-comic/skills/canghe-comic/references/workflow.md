...
test -f .canghe-skills/canghe-comic/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.canghe-skills/canghe-comic/EXTEND.md" && echo "user"
```
...
**Strategy A: Using `--ref` parameter** (e.g., canghe-image-gen)
