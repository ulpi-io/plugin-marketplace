...
description: EXTEND.md YAML schema for canghe-image-gen user preferences
---
...
default_provider: null      # google|openai|dashscope|canghe|null (null = auto-detect)
...
default_model:
  ...
  canghe: null              # e.g., "gemini-3-pro-image-preview"
---
```
...
| `default_model.canghe` | string\|null | null | Canghe default model |
...
default_model:
  ...
  canghe: "gemini-3-pro-image-preview"
---
```
