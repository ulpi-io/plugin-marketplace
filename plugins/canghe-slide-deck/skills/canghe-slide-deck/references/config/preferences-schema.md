...
Structure for user preferences in `.canghe-skills/canghe-slide-deck/EXTEND.md`.
...
Then use with: `/canghe-slide-deck content.md --style style-name`
...
1. `.canghe-skills/canghe-slide-deck/EXTEND.md` (project)
2. `$HOME/.canghe-skills/canghe-slide-deck/EXTEND.md` (user)
