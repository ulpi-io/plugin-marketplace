...
description: First-time setup flow for canghe-cover-image preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.canghe-skills/canghe-cover-image/EXTEND.md` | Current project |
| User | `~/.canghe-skills/canghe-cover-image/EXTEND.md` | All projects |
