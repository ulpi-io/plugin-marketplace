...
function printUsage(cookiePath: string, profileDir: string): void {
  console.log(`Usage:
  npx -y bun skills/canghe-danger-gemini-web/scripts/main.ts --prompt "Hello"
  npx -y bun skills/canghe-danger-gemini-web/scripts/main.ts "Hello"
  npx -y bun skills/canghe-danger-gemini-web/scripts/main.ts --prompt "A cute cat" --image generated.png
...
Multi-turn conversation (agent generates unique sessionId):
  npx -y bun skills/canghe-danger-gemini-web/scripts/main.ts "Remember 42" --sessionId abc123
  npx -y bun skills/canghe-danger-gemini-web/scripts/main.ts "What number?" --sessionId abc123
