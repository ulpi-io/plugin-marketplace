...
description: First-time setup flow for canghe-danger-x-to-markdown preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.canghe-skills/canghe-danger-x-to-markdown/EXTEND.md` | All projects |
| Project | `.canghe-skills/canghe-danger-x-to-markdown/EXTEND.md` | Current project |
