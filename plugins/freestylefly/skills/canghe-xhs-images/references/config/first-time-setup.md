...
description: First-time setup flow for canghe-xhs-images preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.canghe-skills/canghe-xhs-images/EXTEND.md` | Current project |
| User | `~/.canghe-skills/canghe-xhs-images/EXTEND.md` | All projects |
