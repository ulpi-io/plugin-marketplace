...
At the moment, only Vite is officially supported but any bundler implementing the `import.meta.hot` spec should work (e.g. webpack seems to use `import.meta.webpackHot` instead of `import.meta.hot`). 
