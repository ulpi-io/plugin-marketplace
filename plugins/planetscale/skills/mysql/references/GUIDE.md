...
This guide provides comprehensive documentation for the **mysql** skill in the custom-plugin-sql plugin.
...
```bash
# Invoke the skill
claude "mysql - [your task description]"

# Example
claude "mysql - analyze the current implementation"
```
...
def implement_mysql(input_data):
    """
    Implement mysql functionality.
