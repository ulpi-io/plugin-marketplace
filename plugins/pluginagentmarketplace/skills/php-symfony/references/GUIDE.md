...
This guide provides comprehensive documentation for the **php-symfony** skill in the custom-plugin-php plugin.
...
```bash
# Invoke the skill
claude "php-symfony - [your task description]"

# Example
claude "php-symfony - analyze the current implementation"
```
...
def implement_php_symfony(input_data):
    """
    Implement php-symfony functionality.
