...
# Integrated with the RomanceAffectionManager for milestone-based route unlocking.

class_name RomanceRouteManager
extends Node
...
func _ready() -> void:
	...
	# RomanceAffectionManager.milestone_reached.connect(_on_affection_milestone)
