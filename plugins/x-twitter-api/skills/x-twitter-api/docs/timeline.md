Retrieves the authenticated user's home timeline (reverse chronological). Maps to GET /2/users/:id/reverse_chronological. Invoke via `node <base_directory>/x.js timeline [flags]`. Output is JSON to stdout.
